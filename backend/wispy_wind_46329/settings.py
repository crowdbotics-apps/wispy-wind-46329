"""
Django settings for wispy_wind_46329 project.
...
ROOT_URLCONF = 'wispy_wind_46329.urls'
...
WSGI_APPLICATION = 'wispy_wind_46329.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_wind_46329 API",
    "DESCRIPTION": "API documentation for wispy_wind_46329 App",
    "VERSION": "v1",
}
